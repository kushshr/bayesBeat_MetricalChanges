...
Params.results_path = fullfile(Params.base_path, 'BayesResultsFull_tempoInformedCheck');
...
Params.peakInfModeName = {'NoHop', 'PeakHop', 'FixHop', 'HopObs'};
...
% ***Variant 4. Tempo, sama instances informed
...
%          3) Future option: a few samas here and there annotated
Params.tempoInfMode = 2;
Params.tempoInfMargin = 0.1;    % +/- percentage of max variation in median tempo allowed
Params.tempoInfModeName = {'tempoNoInf', 'tempoInf', 'tempoSamaInf', 'future'};
Params.store_name = [Params.store_name '_' Params.tempoInfModeName{Params.tempoInfMode+1}];
% Other tempo variables
% ----------------
...
Params.min_tempo = [30 60 60 30];
Params.max_tempo = [110 220 220 110];
